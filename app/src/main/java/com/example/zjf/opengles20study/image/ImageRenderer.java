package com.example.zjf.opengles20study.image;
...
import com.example.zjf.opengles20study.base.BaseGLSL;
...
public class ImageRenderer extends BaseGLSL implements GLSurfaceView.Renderer{
    ...
    public ImageRenderer(Context context) throws IOException {
        mContext = context;
        mBitmap = BitmapFactory.decodeStream(mContext.getResources().getAssets().open("fengjing.png"));
